      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {experienceData.map((exp, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-2xl border border-[var(--neon-color)] bg-[var(--card-bg)] p-6 transition-all duration-300 hover:shadow-[0_0_30px_rgba(var(--neon-rgb),0.15)]"
              data-aos="fade-up"
