export const projects = [
  ...
  },
  {
    ...
    description: 'An advanced Attendance Calculator tailored for students to effortlessly manage their attendance records. Features include LTPS (Lecture, Tutorial, Practical, Skill) attendance tracking, real-time calculation of attendance percentages, and intelligent suggestions on classes to attend or skip to maintain desired attendance levels.',
  ...
  },
  {
    ...
    description: 'A Sentiment Analysis System that analyzes text and provides insights into its sentiment. Features include text preprocessing, sentiment analysis, and real-time updates for users.',
    image: '/projects/sentiment.png',
    technologies: ['React.s', 'Gemini API','Nelify'],
    githubLink: 'https://github.com/NikileshReddyT/Sentiment-Analysis-Gemini-API',
    demoLink: 'https://sentimentanalizer.netlify.app/'
  },
  {
    title: 'AI-Imgae-Generator',
    description: 'An AI-powered image generation tool leveraging the Pollination API to create unique and diverse visual content. Users can input text prompts or parameters to generate custom images for various applications, from digital art to design prototypes.',
    image: '/projects/aiimggen.png',
    technologies: ['React.s', 'Pollination API','Nelify'],
    githubLink: 'https://github.com/NikileshReddyT/AI_Image_Generation',
    demoLink: 'https://fabulous-dodol-85d593.netlify.app/'
  },
  {
    title: 'Event Management System',
    description: 'A robust Event Management System that simplifies event planning and management. Features include event scheduling, attendee registration, and real-time updates for event organizers and attendees.',
    image: '/projects/event.png',
    technologies: ['React.s', 'Express.js', 'Node.js', 'MongoDB'],
